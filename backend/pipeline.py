...
from modules.tracker import PlayerBallTracker
from modules.team_assigner import TeamAssigner
from modules.player_reid import PlayerReIDModule
from strategic_hybrid_detector import StrategicHybridEventDetector
from statsbomb_export import StatsBombExporter
from utils.video_utils import VideoReader, VideoWriter
from utils.drawing_utils import Annotator
from utils.data_export import MatchDataExporter

# Import robust Re-ID system for stable IDs
try:
    from robust_reid import RobustReIDSystem
except ImportError:
    import sys
...
try:
    from integration.ml_event_detector import MLEventDetector, integrate_ml_detector_into_pipeline
    ML_AVAILABLE = True
except ImportError:
